...
smaller_number_of_axon_sections = {'L1_DAC_bNA': 2, 'L1_DAC_cNA': 1, 'L1_DLAC_cNA': 4, 'L1_HAC_bNA': 3, 'L1_HAC_cIR': 5, 'L1_HAC_cNA': 4, 'L1_NGC_DA_bNA': 3, 
...
if cfg.addIClamp:
    for pop in Epops+Ipops:
        ...
        # add stim source
        netParams.stimSourceParams['IClamp->' + pop] = {'type': 'IClamp', 'delay': 300.0, 'dur': 500.0, 'amp': 0.3}
