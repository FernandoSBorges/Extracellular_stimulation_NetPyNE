...
if __name__ == '__main__':
    ...
    if dataType == 'spont':
        filenames = ['../data/v1_batch1/v1_batch1_%d_data.pkl' % (iseed) for iseed in [0]]
        timeRange = [2000, 4000]
    ...
    for filename in filenames:
        ...
        sim.analysis.plotRaster(**{'include': RP_L6, 'saveFig': True, 'showFig': False, 'orderInverse': True, 'timeRange': timeRange, 'fontSize':12, 'figSize': (24,24), 'lw': 4.0, 'markerSize': 4, 'marker': 'o', 'dpi': 300})
        # timeRange = [0, 5000]
